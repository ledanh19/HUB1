...
GRANT EXECUTE ON FUNCTION public.create_cash_out_atomic(UUID, NUMERIC, TEXT, TIMESTAMPTZ, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN, TEXT, TEXT) TO authenticated;
