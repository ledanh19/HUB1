-- Step 1: Drop old single-param version
DROP FUNCTION IF EXISTS public.recalculate_ota_payout_status_v2(uuid);

-- Step 2: Create new version with p_received_at
...
-- Step 3: Recreate create_multi_payout_cashin_atomic
...
GRANT EXECUTE ON FUNCTION public.create_multi_payout_cashin_atomic(UUID[], NUMERIC[], UUID, TEXT, TEXT, TEXT, TEXT, TEXT, UUID, NUMERIC) TO authenticated;