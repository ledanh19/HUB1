-- ============================================================
-- SPRINT C: ADD CLASSIFICATION SUPPORT TO ota_create_task
-- ============================================================
-- Date: 2026-01-10
-- Purpose: Allow specifying classification when creating task
--          Enables HANDOVER task creation with OPS classification
-- 
-- Changes:
--   - Add p_classification parameter to ota_create_task RPC
--   - Default to 'EXECUTION' for backward compatibility
--
-- Rollback:
--   -- Restore previous version without p_classification
-- ============================================================

-- ============================================================
-- STEP 1: Update ota_create_task with classification support
-- ============================================================
CREATE OR REPLACE FUNCTION public.ota_create_task(
  ...
  p_tags TEXT[] DEFAULT '{}',
  p_classification TEXT DEFAULT 'EXECUTION'  -- NEW: classification support
)
RETURNS JSON
LANGUAGE plpgsql
SECURITY DEFINER
...
-- ============================================================
-- STEP 2: Grant permissions (idempotent)
-- ============================================================
...
RAISE NOTICE 'Migration 20260110_031_sprint_c_task_classification completed successfully';
