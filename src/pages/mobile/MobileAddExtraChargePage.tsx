...
import { AddExtraChargeForm } from "@/components/booking/forms/AddExtraChargeForm";
import { useCallback } from "react";

export default function MobileAddExtraChargePage() {
  const { id } = useParams();
  ...
  if (isLoading || !booking) {
    return (
      <MobileTaskPage title="Thêm phụ phí Host" onBack={handleBack} hideSubmit>
