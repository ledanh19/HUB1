...
-- Drop and recreate unified_bookings view to get host data from host_supply_segments instead of stays
...
SELECT 
    ...
    -- Get host info from first host_supply_segment
...
SELECT 
    ...
    c.nationality,
    mb.source,
    NULL::text AS pms_property_name,  -- Manual bookings don't have OTA/PMS property
    -- Get host info from first host_supply_segment
    hss.host_property_name,
    hss.host_room_type,
    hss.host_room_id,
