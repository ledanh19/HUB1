...
-- Fix: create_ota_payout_cashin_atomic (single payout) - same TEXT→DATE cast bug
...
BEGIN
  ...
  -- FIX: cast p_received_at::DATE for entry_date
  ...
  -- FIX: cast p_received_at::DATE for cash_date
  INSERT INTO cashflow_entries (cash_date, amount, direction, source_type, source_id, counterparty_type, note, created_by)
  VALUES (p_received_at::DATE, p_amount, 'IN', 'OTA_PAYOUT_CASH_IN', v_collection_id::TEXT, 'OTA',
