...
-- 1. Add nationality column to bookings_mirror
ALTER TABLE public.bookings_mirror ADD COLUMN IF NOT EXISTS nationality TEXT;

-- 2. Recreate unified_bookings view with COALESCE for nationality
