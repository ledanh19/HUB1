...
COMMENT ON TABLE public.cashflow_whitelist_events IS
  'Append-only telemetry for whitelisted cashflow inserts.';
...
COMMENT ON FUNCTION public.fn_enforce_cashflow_ledger_coupling() IS
  'Deferred constraint trigger for cashflow-ledger coupling.';
...
-- F2. PERIOD LOCK — cashflow_entries
