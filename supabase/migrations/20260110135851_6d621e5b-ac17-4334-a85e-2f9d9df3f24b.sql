-- Fix create_collection_ledger_atomic to match post_ledger_entry_idempotent signature
...
BEGIN
  ...
  -- Create ledger entry using idempotent function (FIXED: correct parameter order)
