...
-- Fix: post_ota_payout_adjustment_to_ledger_atomic references v_payout.org_id
-- but ota_payouts has no org_id column. Use default org_id instead.
...
BEGIN
    ...
    WHERE source_type = 'OTA_PAYOUT_ADJUSTMENT'
      AND source_id = p_recon_item_id::text
